...
export const SET_REQ_DELIVERY_ADDRESS_COORDINATES =
  'SET_REQ_DELIVERY_ADDRESS_COORDINATES';
export const SET_REQ_PICKUP_ADDRESS_COORDINATES =
  'SET_REQ_PICKUP_ADDRESS_COORDINATES';
